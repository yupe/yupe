...
(function (c) {
    c.widget("ui.rangeSliderBar", c.ui.rangeSliderDraggable, {options:{leftHandle:null, rightHandle:null, bounds:{min:0, max:100}, type:"rangeSliderHandle", range:!1, drag:function () {
        ...
        if (!(a === !1 && this.options.range === !1))this.options.range = a !== !1 ? {min:typeof a.min === "undefined" ? this.options.range.min || !1 : a.min, max:typeof a.max === "undefined" ? this.options.range.max || !1 : a.max} : !1, this._setLeftRange(), this._setRightRange()
...
(function (c) {
    ...
    c.widget("ui.rangeSliderLabel", c.ui.rangeSliderMouseTouch, {options:{handle:null,
        ...
        }, _onSwitch:function (a, c) {
            this.options.isLeft = c;
            this._toggleClass();
            this._positionner.PositionLabels()
        }, pair:function (b) {
            if (this._positionner == null)this._positionner = new a(this.element, b, this.widgetName, {show:this.options.show, durationIn:this.options.durationIn, durationOut:this.options.durationOut, delayOut:this.options.delayOut}), b[this.widgetName]("positionner", this._positionner)
    ...
    c.widget("ui.editRangeSliderLabel", c.ui.rangeSliderLabel, {options:{type:"text", step:!1, id:""}, _input:null, _text:"", _create:function () {
        ...
        _destroyInput:function () {
            ...
            this.element.trigger("valueChange", [
                {isLeft:this.options.handle[this.options.handleType]("option", "isLeft"), value:a}
            ])
