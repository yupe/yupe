<html>
	<head>
	   <title><?php echo Yii::t('user','Сброс пароля для сайта');?> <?php echo CHtml::encode(Yii::app()->name);?></title>
	</head>
	<body>
	   <?php echo Yii::t('user','Сброс пароля для сайта');?> <b><?php echo CHtml::encode(Yii::app()->name);?></b> !<br/>
	   
	   <?php echo Yii::t('user','Кто-то, возможно Вы, запросил сброс пароля для сайта');?> <b><?php echo CHtml::encode(Yii::app()->name);?></b> <?php echo Yii::t('user','если это были не Вы - просто удалите это письмо.');?>
	   <br>
