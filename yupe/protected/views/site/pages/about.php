...
<b>!!!ВНИМАНИЕ!!! <br/> Юпи! пока не готов для "промышленного" использования, Вы делаете это на свой страх и риск!</b><br/><br/>
...
<p>Используя <b>Юпи!</b>, Вы сможете развернуть сайт или блог, работающий на фреймворке <b>Yii</b> всего за 5 минут !</p>
...
<p><b>Юпи!</b> - это <b>НЕ</b> универсальный конструктор сайтов, типа Drupal или Joomla, Вы просто берете готовый функционал и используете его!</p>
...
<p>Желающим помочь проекту рекомендую посетить <?php echo CHtml::link('эту страничку',array('/site/page/','view' => 'help'));?>.</p>
