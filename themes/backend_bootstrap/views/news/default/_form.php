...
<?php echo $form->textArea($model, 'description', array( 'rows' => 6, 'cols' => 86 )); ?>
            <div class="alert alert-info"><?php echo Yii::t('news', "Более подробно вы можете прочитать про поисковую оптимизацию сайта в <a href='http://help.yandex.ru/webmaster/recomend.pdf'>этом документе</a>.");
; ?></div>
        </div>
        <div class="span5">
