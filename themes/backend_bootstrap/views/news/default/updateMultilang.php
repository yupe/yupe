...
echo "<br />";
echo CHtml::submitButton($model->isNewRecord ? Yii::t('news', 'Добавить новость и продолжить редактирование') : Yii::t('news', 'Сохранить и продолжить редактирование'), array(
