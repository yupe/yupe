...
<div class="row-fluid">
    ...
    <div class='span6'>
        ...
        <a href="<?php echo Yii::app()->createUrl('/blog/rss/feed/',array('blog' => $blog->id));?>"><img src="<?php echo Yii::app()->AssetManager->publish(Yii::app()->theme->basePath . "/web/images/rss.png"); ?>" alt="Подпишитесь на обновление блога '<?php echo $blog->name?>'" title="Подпишитесь на обновление блога '<?php echo $blog->name?>'"></a>
        <br/>
