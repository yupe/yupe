<div class="row-fluid">
    ...
    <div class="span7 blog-info">
        ...
        <span class="icon-user"> <?php echo CHtml::image($data->createUser->getAvatar(16), $data->createUser->nick_name); ?>  <?php echo CHtml::link($data->createUser->nick_name, array('/user/people/userInfo', 'username' => $data->createUser->nick_name)); ?> </span>
        <span class="icon-calendar"> <?php echo Yii::app()->getDateFormatter()->formatDateTime($data->create_date, "short", "short"); ?> </span>
