<?php if ($user->isAuthenticated()): ?>
    <?php if (false === $inBlog || UserToBlog::STATUS_DELETED === $inBlog): ?>
        <a class="btn btn-warning pull-right join-blog" href="<?php echo $blog->id; ?>"><?php echo Yii::t(
                'BlogModule.blog',
                'Join blog'
            ); ?></a>
    ...
    <?php else: ?>
        <a class="btn btn-warning pull-right leave-blog" href="<?php echo $blog->id; ?>"><?php echo Yii::t(
                'BlogModule.blog',
                'Leave blog'
            ); ?></a>
    <?php endif; ?>
