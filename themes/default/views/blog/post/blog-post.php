<?php
    ...
    $this->description = Yii::t('BlogModule.blog','Posts of "{blog}" blog', array('{blog}' => CHtml::encode($target->name)));
...
<p><?php echo Yii::t('BlogModule.blog','Posts of "{blog}" blog', array('{blog}' => CHtml::encode($target->name)));?></p>
