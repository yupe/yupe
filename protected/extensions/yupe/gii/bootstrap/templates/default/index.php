...
?>
$this-> pageTitle ="<?=$label ?> - управление";
$this->menu=array(
array('icon'=> 'list-alt white', 'label' => 'Управление <?php echo $this->mtvor; ?>','url'=>array('<?=$this->controller; ?>/index')),
array('icon'=> 'file', 'label' => 'Добавить <?=$this->vin ?>', 'url' => array('<?=$this->controller; ?>/create')),
);
<?php echo "?>"; ?>
...
<button class="btn btn-small dropdown-toggle"
    ...
    <?=CHtml::link('Поиск '.$this-> mrod, '#', array('class' => 'search-button'))?>
