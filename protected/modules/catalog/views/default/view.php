<?php
    ...
    $this->menu = array(
        ...
        array('icon' => 'pencil', 'label' => Yii::t('CatalogModule.catalog', 'Edit product'), 'url' => array(
            '/catalog/default/update',
            'id' => $model->id
        )),
        array('icon' => 'eye-open', 'label' => Yii::t('CatalogModule.catalog', 'View product'), 'url' => array(
        ...
        array('icon' => 'trash', 'label' => Yii::t('CatalogModule.catalog', 'Delete product'), 'url' => '#', 'linkOptions' => array(
            ...
            'confirm' => Yii::t('CatalogModule.catalog', 'Are you sure you want to remove product?'),
            'csrf' => true,
        )),
    );
?>
<div class="page-header">
    <h1>
        <?php echo Yii::t('CatalogModule.catalog', 'Product view'); ?><br />
