...
class DefaultController extends YFrontController
{
    ...
    public function actionLogin()
    {
        ...
        if ($service !== null)
        {
            ...
            $authIdentity->cancelUrl = $this->createAbsoluteUrl('/social/default/login');
                ...
                if ($identity->authenticate())
                {
                    ...
                    else
                    {
                        ...
                        if ($user)
                        {
                            ...
                            $this->redirect(array('/social/default/registration'));
                        }
            ...
            $this->redirect(array('/social/default/login'));
        }
    }
