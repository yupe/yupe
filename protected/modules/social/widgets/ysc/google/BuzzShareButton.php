...
class BuzzShareButton extends YscPortlet
{
    ...
    {
        echo <<<EOF
        <a title='{$this->title}' class='google-buzz-button' href='http://www.google.com/buzz/post' data-button-style='{$this->type}' data-locale='{$this->locale}' {$this->url} {$this->imageUrl}></a>
