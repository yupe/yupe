...
class TwitterShareButton extends YscPortlet
{
    ...
    {
        echo <<<EOF
            <a href="http://twitter.com/share" class="twitter-share-button" data-url="{$this->url}" data-text="{$this->text}" data-count="{$this->type}" data-via="{$this->via}" data-related="{$this->related}" data-lang="{$this->lang}">Twitter</a>
