...
return array(
    ...
    'rules' => array(
        '/login/service/<service:(google|google-oauth|yandex|yandex-oauth|twitter|linkedin|vkontakte|facebook|mailru|moikrug|github|live|odnoklassniki)>' => 'social/user/login',
    ),
);