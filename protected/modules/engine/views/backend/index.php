<div class="page-header">
    <h1><?php echo Yii::t('YupeModule.engine', 'Панель управления "{app}"', array('{app}' => CHtml::encode(Yii::t('YupeModule.engine', Yii::app()->name)))); ?><br/></h1>
</div>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a  class="accordion-toggle"
                                ...
                                >
                                <?php echo Yii::t('YupeModule.engine', 'Модуль {icon} "{module}", сообщений: {count}', array(
                                ...
                                <div class="accordion-inner">
                                    <div class="alert alert-<?php echo $error['type']; ?>">
                                        <h4 class="alert-heading">
                                            <?php echo Yii::t('YupeModule.engine', 'Модуль "{module} ({id})"', array(
                                                    '{module}' => $module->name,
                                                    '{id}'     => $module->getId(),
                                                )); ?>
                                        </h4>
...
<div class="alert">
    <p>
        ...
        <?php echo Yii::t('YupeModule.engine', 'модуль|модуля|модулей', $allCount); ?>,
        <?php echo Yii::t('YupeModule.engine', 'включено'); ?>
        <small class="label label-info"><?php echo $enableCount + $yiiCount; ?></small>
        <?php echo Yii::t('YupeModule.engine', 'модуль|модуля|модулей', $enableCount + $yiiCount); ?>,
...
<legend><?php echo Yii::t('YupeModule.engine', 'Быстрый доступ к модулям'); ?></legend>
<?php
$this->widget(
    'engine.widgets.YShortCuts', array(
