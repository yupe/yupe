...
$this->breadcrumbs = array(
    ...
    Yii::t('YupeModule.engine', 'Сообщить об ошибке'),
); ?>
...
<div class='row-fluid'>
        ...
        $form = $this->beginWidget(
            ...
            <div class="alert alert-block alert-info">
                <p><?php echo Yii::t('YupeModule.engine','Прежде чем писать нам, пожалуйста, проверьте следующие источники:');?></p>
                <p><?php echo CHtml::link(Yii::t('YupeModule.engine','Официальный форум'),'http://engine.ru/talk?from=bug_report',array('target' => '_blank'));?></p>
                <p><?php echo CHtml::link(Yii::t('YupeModule.engine','Официальная документация'),'http://engine.ru/docs/index.html?from=bug_report',array('target' => '_blank'));?></p>
                <p><?php echo CHtml::link(Yii::t('YupeModule.engine','Тикеты на Github'),'https://github.com/engine/engine/issues?labels=&milestone=&page=1&state=open',array('target' => '_blank'));?></p>
            </div>
            <legend><?php echo Yii::t('YupeModule.engine', 'Сообщить об ошибке'); ?></legend>
            ...
            $this->widget(
                'bootstrap.widgets.TbButton', array(
                    ...
                    'label'       => Yii::t('YupeModule.engine', 'Отправить сообщение разработчикам'),
                )
            ); ?>
