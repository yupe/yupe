 ...
 * Основная особенность - view файлы для виджетов хранятся в каталоге "widgets" текущей темы, подробнее https://github.com/engine/engine/issues/26
 *
 * @package engine.core.widgets
 * @abstract
 * @author engine team
 * @link http://engine.ru
 *
...
abstract class YWidget extends CWidget
{
    ...
    public function init()
    {
        ...
        //if (!$this->cacheTime && $this->cacheTime !== 0)
            //$this->cacheTime = Yii::app()->getModule('engine')->coreCacheTime;
    }
