...
class Settings extends YModel
{
    ...
    */
    ...
    {
        return array(
            'id'            => Yii::t('YupeModule.engine', 'ID'),
            'module_id'     => Yii::t('YupeModule.engine', 'Модуль'),
            'param_name'    => Yii::t('YupeModule.engine', 'Имя параметра'),
            'param_value'   => Yii::t('YupeModule.engine', 'Значение параметра'),
            'creation_date' => Yii::t('YupeModule.engine', 'Дата создания'),
            'change_date'   => Yii::t('YupeModule.engine', 'Дата изменения'),
            'user_id'       => Yii::t('YupeModule.engine', 'Пользователь'),
        );
    }
    ...
    public function fetchModuleSettings($moduleId, array $params = null)
    {
        ...
        if ($moduleId)
        {
            ...
            $dependency = new TagsCache($moduleId, 'engine');

            $q = $this->cache(Yii::app()->getModule('engine')->coreCacheTime, $dependency)->findAll($criteria);
