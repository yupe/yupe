...
");
?>
<h1><?php echo Yii::t('YupeModule.engine', 'Юпи! Генератор!'); ?></h1>

<p><?php echo Yii::t('YupeModule.engine', 'Юпи! Генератор позволяет создать CRUD для любой модели.'); ?></p>

<p><?php echo Yii::t('YupeModule.engine', ' Полученный интерфейс благополучно интегрируется в панель управления Юпи!.'); ?></p>

<p><?php echo Yii::t('YupeModule.engine', 'Более подробную информацию и техническую поддержку Вы можете получить на сайте {site}.', array('{site}' => CHtml::link(Yii::t('YupeModule.engine', 'Юпи!'), 'http://engine.ru/?from=generator'))); ?></p>
