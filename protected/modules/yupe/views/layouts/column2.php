...
<div class="row">
    <div class="<?php echo $this->hideSidebar ? 'col-sm-12' : 'col-sm-12 col-mg-12 col-lg-10'; ?>">
        <?php
    ...
    <div class="<?php echo $this->hideSidebar ? 'hidden' : 'col-sm-2 hidden-xs hidden-sm hidden-md'; ?>">
