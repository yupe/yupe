            ...
            <div class="cn">
                ...
                <?php if(Yii::app()->getUser()->isSuperUser()):?>
                    <?php if($module->isConfigNeedUpdate()):?>
                        <span class='label label-warning config-update' data-module="<?php echo $module->getId();?>"  data-toggle="tooltip" data-placement="top" title="<?php echo Yii::t('YupeModule.yupe','Apply new configuration');?>"><i class='glyphicon glyphicon-refresh pull-left'></i></span>
                    <?php endif;?>
