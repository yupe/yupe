...
<p>
    ...
    <small class="label label-info" title="<?php echo $this->yupe->version; ?>"><?php echo $this->yupe->version; ?></small>
    ,
...
<?php echo CHtml::link(Yii::t('YupeModule.yupe', 'Official Yupe! docs', array('target' => '_blank')), 'http://yupe.ru/docs/index.html?form=help'); ?> - <?php echo Yii::t(
    'YupeModule.yupe',
...
<?php echo CHtml::link(Yii::t('YupeModule.yupe', 'Additional modules and components'), 'https://github.com/yupe/yupe-ext', array('target' => '_blank')); ?> - <?php echo Yii::t(
    'YupeModule.yupe',
    'Submit an extension!'
); ?>
...
<?php echo CHtml::link(Yii::t('YupeModule.yupe', 'Sources on Github'), 'http://github.com/yupe/yupe/', array('target' => '_blank')); ?> - <?php echo Yii::t(
    'YupeModule.yupe',
...
<?php echo CHtml::link(Yii::t('YupeModule.yupe', 'General sponsor'), 'http://amylabs.ru?from=yupe-help', array('target' => '_blank')); ?> - <?php echo Yii::t(
    'YupeModule.yupe',
    'Just great guys =)'
); ?>
...
<div class="alert alert-warning">
    <?php echo Yii::t(
        ...
        array('{link}' => CHtml::link(Yii::t('YupeModule.yupe', 'feedback form'), 'http://yupe.ru/contacts?from=help', array('target' => '_blank')))
