...
<p><?php echo Yii::t('yupe', 'Более подробную информацию и техническую поддержку Вы можете получить на сайте {site}.', array('{site}' => CHtml::link(Yii::t('yupe', 'Юпи!'), 'http://yupe.ru/?from=generator'))); ?></p>
