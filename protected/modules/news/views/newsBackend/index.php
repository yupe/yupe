    ...
    'bulkActions'      => array(
        'actionButtons' => array(
            array(
                ...
                'type'       => 'danger',
                'size'       => 'small',
                'label'      => Yii::t('NewsModule.news', 'Delete'),
                'click'      => 'js:function(values){ if(!confirm("' . Yii::t('NewsModule.news', 'Do you really want to delete selected elements?') . '")) return false; multiaction("delete", values); }',
            ),
        ),
