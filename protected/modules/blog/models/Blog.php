...
class Blog extends YModel
{
    ...
    public function attributeDescriptions()
    {
        return array(
            ...
            'slug'           => Yii::t('blog', "Краткое название новости латинскими буквами, используется для формирования адреса блога.<br /><br /> Например (выделено темным фоном): <pre>http://site.ru/blogs/<span class='label'>zametky-putnika</span>/</pre> Если вы не знаете, для чего вам нужно это поле &ndash; не заполняйте его, названия блога будет достаточно."),
