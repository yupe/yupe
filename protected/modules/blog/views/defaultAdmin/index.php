        ...
        **/
        ...
        'columns'      => array(
            ...
            array(
                'name'  => 'name',
                'type'  => 'raw',
                'value' => 'CHtml::link($data->name, array("/blog/defaultAdmin/update", "id" => $data->id))',
            ),
            array(
            ...
            array(
                'name'  => 'create_user_id',
                'type'  => 'raw',
                'value' => 'CHtml::link($data->createUser->getFullName(), array("/user/defaultAdmin/view", "id" => $data->createUser->id))',
            ),
            array(
                'name'  => 'create_date',
