...
?>
    ...
    <fieldset class="inline">
        <div class="wide row-fluid control-group">
            ...
            <div class="span3">
                <?php echo $form->dropDownListRow($model, 'blog_id', CHtml::listData(Blog::model()->findAll(), 'id', 'name'), array('empty'=>Yii::t('BlogModule.blog', 'choose blog'), 'class' => 'popover-help', 'data-original-title' => $model->getAttributeLabel('blog_id'), 'data-content' => $model->getAttributeDescription('blog_id'))); ?>
            </div>
            <div class="span3">
    ...
    $this->widget(
        'bootstrap.widgets.TbButton', array(
            ...
            'encodeLabel' => false,
            'buttonType'  => 'submit',
            'label'       => '<i class="icon-search icon-white">&nbsp;</i> ' . Yii::t('BlogModule.blog', 'Find post'),
        )
    ); ?>
