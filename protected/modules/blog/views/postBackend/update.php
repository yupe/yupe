...
$this->menu = array(
    ...
    array('label' => Yii::t('BlogModule.blog', 'Posts'), 'items' => array(
        ...
        array('icon' => 'glyphicon glyphicon-pencil', 'label' => Yii::t('BlogModule.blog', 'Edit posts'), 'url' => array(
            '/blog/postBackend/update',
            'id' => $model->id
        )),
        array('icon' => 'glyphicon glyphicon-comment', 'label' => Yii::t('BlogModule.blog', 'Comments'), 'url' => array(
            '/comment/commentBackend/index',
            'Comment[model_id]' => $model->id,
            'Comment[model]' => 'Post'

        )),
        array('icon' => 'glyphicon glyphicon-eye-open', 'label' => Yii::t('BlogModule.blog', 'View post'), 'url' => array(
            '/blog/postBackend/view',
            'id' => $model->id
        )),
        array('icon' => 'glyphicon glyphicon-trash', 'label' => Yii::t('BlogModule.blog', 'Remove post'), 'url' => '#', 'linkOptions' => array(
