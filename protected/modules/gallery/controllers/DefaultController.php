...
class DefaultController extends YBackController
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Gallery']))
		{
			...
			if($model->save())
            {
                Yii::app()->user->setFlash(YFlashMessages::NOTICE_MESSAGE,Yii::t('gallery','Запись добавлена!'));
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Gallery']))
		{
			...
			if($model->save())
                        {
                            Yii::app()->user->setFlash(YFlashMessages::NOTICE_MESSAGE,Yii::t('gallery','Запись обновлена!'));
	...
	public function actionDelete($id)
	{
		if(Yii::app()->request->isPostRequest)
		{
			...
			$this->loadModel($id)->delete();
                        ...
                        Yii::app()->user->setFlash(YFlashMessages::NOTICE_MESSAGE,Yii::t('gallery','Запись удалена!'));
