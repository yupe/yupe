<div class="view">
    ...
    <a href='<?php echo $this->createUrl('/gallery/gallery/foto/', array('id' => $data->image->id));?>'><?php echo CHtml::image($data->image->file, $data->image->name, array('width' => 75, 'height' => 75));?></a>
    <br/>
