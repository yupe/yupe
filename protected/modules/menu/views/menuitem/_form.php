...
?>
    ...
    <?php echo $form->errorSummary($model); ?>
        ...
        <div class="row-fluid control-group <?php echo $model->hasErrors('title')?'error':'' ?>">
            <div class="span7 popover-help" data-content="<?php echo Yii::t('menu', "Заголовок пункта меню<br /><br />Например:<br /><pre>'О проекте'</pre>") ?>" data-original-title="<?php echo $model-> getAttributeLabel('title'); ; ?>" >
        ...
        <div class="row-fluid control-group <?php echo $model->hasErrors('href')?'error':'' ?>">
            <div class="span7 popover-help" data-content="<?php echo Yii::t('href', "Адрес ссылки<br /><br />Например:<br /><pre>'/about/'</pre>") ?>" data-original-title="<?php echo $model-> getAttributeLabel('href'); ; ?>" >
        ...
        <div class="row-fluid control-group <?php echo $model->hasErrors('sort')?'error':'' ?>">
            <div class="span7 popover-help" data-content="<?php echo Yii::t('sort', "Порядок следования пункта меню") ?>" data-original-title="<?php echo $model-> getAttributeLabel('sort'); ; ?>" >
