...
class MenuController extends YBackController
{
    ...
    {
        $this->render('../menuitem/view', array('model' => $this->loadModelItem($id)));
    }
    ...
    public function actionAddMenuItem()
    {
        ...
        $this->render('../menuitem/create', array('model' => $model));
    }
    ...
    public function actionUpdateMenuItem($id)
    {
        ...
        $this->render('../menuitem/update', array('model' => $model));
    }
    ...
    public function actionIndexMenuItem()
    {
        ...
        $this->render('../menuitem/index', array('dataProvider' => $dataProvider));
    }
    ...
    public function actionAdminMenuItem()
    {
        ...
        $this->render('../menuitem/admin', array('model' => $model));
    }
