...
class m121220_001126_menu_test_data extends yupe\components\DbMigration
{
    ...
    public function safeUp()
    {
        ...
        $items = [
            ...
            [0, 1, 'Войти', '/login', 'login-text', 'Войти на сайт', '', '', '', '', 'isAuthenticated', 1, 11, 1, 1],
            [0, 1, 'Выйти', '/logout', 'login-text', 'Выйти', '', '', '', '', 'isAuthenticated', 0, 12, 1, 1],
            [0, 1, 'Регистрация', '/registration', 'login-text', 'Регистрация на сайте', '', '', '', '', 'isAuthenticated', 1, 10, 1, 1],
            [0, 1, 'Панель управления', '/yupe/backend/index', 'login-text', 'Панель управления сайтом', '', '', '', '', 'isSuperUser', 0, 13, 1, 0],
            [0, 1, 'FAQ', '/faq', '', 'FAQ', '', '', '', '', '', 0, 7, 1, 1],
            [0, 1, 'Контакты', '/contacts', '', 'Контакты', '', '', '', '', '', 0, 7, 1, 1],
