...
class m000000_000000_page_base extends CDbMigration
{
    ...
    public function safeUp()
    {
        ...
        $this->createIndex("page_slug_uniq", $db->tablePrefix . 'page', "slug,lang", true);
        $this->createIndex("page_status", $db->tablePrefix . 'page', "status", false);
        $this->createIndex("page_protected", $db->tablePrefix . 'page', "is_protected", false);
        $this->createIndex("page_user_id", $db->tablePrefix . 'page', "user_id", false);
        $this->createIndex("page_change_user_id", $db->tablePrefix . 'page', "change_user_id", false);
        $this->createIndex("page_order", $db->tablePrefix . 'page', "menu_order", false);
        $this->createIndex("page_category_id", $db->tablePrefix . 'page', "category_id", false);
    ...
    public function safeDown()
    {
        ...
        /*
        $this->dropIndex("page_slug_uniq", $db->tablePrefix . 'page');
        $this->dropIndex("page_status", $db->tablePrefix . 'page');
        $this->dropIndex("page_protected", $db->tablePrefix . 'page');
        $this->dropIndex("page_user_id", $db->tablePrefix . 'page');
        $this->dropIndex("page_change_user_id", $db->tablePrefix . 'page');
        $this->dropIndex("page_order", $db->tablePrefix . 'page');
        $this->dropIndex("page_category_id", $db->tablePrefix . 'page');
        */
