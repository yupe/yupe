...
return array (
  ...
  'Email selected during registration was added in black list! Registration can\'t be continued' => 'Email указанный Вами при регистрации занесен в черный список! Регистрация невозможна!',
  'Id' => 'Id',
  ...
  'Your IP was added in black list! Registration can\'t be continued!' => 'Ваш IP занесен в черный список! Регистрация невозможна!',
  ...
  'Insert text you see on image' => 'Введите текст указанный на картинке',
  'Login' => 'Войти',
  ...
  'Activation success!' => 'Успешная активация аккаунта!',
  ...
  'Insert text you see on image' => 'Введите текст указанный на картинке',
  'Password recovery' => 'Восстановление пароля',
  'Insert your registration e-mail' => 'Введите email, указанный при регистрации',
  'Recover password' => 'Восстановить пароль',
  'User profile' => 'Профиль пользователя',
  'If you do not use Gravatar, upload avatar from file.' => 'Если вы не пользуетесь Gravatar выберите аватарку из файла.',
  'E-mail was checked' => 'E-Mail проверен',
  'e-mail was not confirmed, please check you mail!' => 'e-mail не подтвержден, проверьте почту!',
  'Attention! After e-mail have been changed, you receive e-mail with confirmation' => 'Внимание! После смены e-mail адреса, вам будет выслано письмо для его подтверждения.',
  ...
  'Your IP was added in black list. You can\'t register!'=>'Ваш IP занесен в черный список! Регистрация невозможна!',
  'Your e-mail was added in black list! You can\'t register!' => 'Email указанный Вами при регистрации занесен в черный список! Регистрация невозможна!',
  'Activation success!' => 'Успешная активация аккаунта!',
  'You was successfully registered on "{site}" !' => 'Вы успешно зарегистрировались на сайте "{site}" !',
  'For activate your account please go to ' => 'Для активации аккаунта, пожалуйста, перейдите по ',
  'link' => 'ссылке',
  'Truly yours, administration of "{site}" !' => 'С уважением, администрация сайта "{site}" !',
  'Changing e-mail' => 'Изменение email!',
  'You just successfully change you e-mail on "{site}"!' => 'Вы успешно изменили email на сайте "{site}" !',
  'For e-mail activation, please, go to ' =>'Для активации email, пожалуйста, перейдите по ',
  'Password reset on "{site}".' => 'Сброс пароля для сайта "{site}".',
  'Someone, maybe request password reset on "{site}".' => 'Кто-то, возможно, запросил сброс пароля для сайта "{site}".',
  'If this e-mail is not for you, just delete it.' => 'Если это были не Вы - просто удалите это письмо.',
  'For reset password, please go to ' => 'Для сброса пароля,пожалуйста, перейдите по ',
