...
class m130330_133012_user_mail_templates extends YDbMigration
{
    ...
    public function safeUp()
    {
        ...
        $items = array(
            ...
            array(7, 'registrationMailEventActivate',   7, 'Шаблон письма с просьбой подтверждения ящика после смены e-mail адреса.', NULL, '{from_mail}', '{to_mail}', 'Подтверждение регистрации на сайте {site}. Требуется активация нового e-mail адреса.', 'Здравствуйте!\r\n<br><br>\r\nВы запросили изменение e-mail адреса на сайте "{site}" на этот адрес. \r\n    <br/><br/>\r\nДля активации нового адреса, пожалуйста, перейдите по <a href="{url}">ссылке</a>\r\n<br/><br/>\r\n{url}\r\n<br/><br/>\r\nС уважением, администрация сайта {site}.\r\n', 1),
        ) ;
