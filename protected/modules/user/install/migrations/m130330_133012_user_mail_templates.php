...
class m130330_133012_user_mail_templates extends YDbMigration
{
    ...
    public function safeUp()
    {
        $items = array(
            ...
            array(7,    'USER_CHANGED_EMAIL_ACTIVATION',  Yii::t('userModule.mail_templates', 'Почтовое событие при смене пользователем e-mail адреса с требованием его подтверждения'), '')
        ...
        $items = array(
            ...
            array(2, 'registrationMailEventActivate',   2, 'Шаблон письма с просьбой активации аккаунта.', NULL, '{from_mail}', '{to_mail}', 'Подтверждение регистрации на сайте {site}. Требуется активация.', "Здравствуйте!\r\n<br><br>\r\nВы успешно зарегистрировались на сайте \"{site}\" !\r\n    <br/><br/>\r\nДля активации аккаунта, пожалуйста, перейдите по <a href=\"{url}\">ссылке</a>\r\n<br/><br/>\r\n{url}\r\n<br/><br/>\r\nС уважением, администрация сайта {site}.\r\n", 1),
            array(3, 'registrationMailEvent',           3, 'Шаблон письма, отправляемого при успешной регистрации без требования активации аккаунта.', NULL, '{from_mail}', '{to_mail}', 'Успешная регистрация на сайте {site}.', "<h1>Ваш аккаунт на сайте \"{site}\" успешно создан!</h1>\r\n\r\n    <br/><br/>\r\n\r\nТеперь вы можете войти используя <a href=\"{login_url}\">страницу входа</a>\r\n<br>\r\n{login_url}\r\n<br><br>\r\n\r\nС уважением, администрация сайта {site}.\r\n", 1),
            array(4, 'passwordAutoRecovery',            4, 'Шаблон письма с новым паролем после автовосстановления пароля.', NULL, '{from_mail}', '{to_mail}', 'Ваш новый пароль на сайте {site}.', "<h1>Восстановление пароля для сайта \"{site}\".</h1>\r\n<br>\r\n\r\nВаш новый пароль : <b>{password}</b><br>\r\nПомните – его всегда можно сменить в вашем профиле на сайте.\r\n<br>\r\nИспользуя данный пароль, вы можете теперь воти используя <a href=\"{login_url}\">страницу входа</a>\r\n<br>\r\n{login_url}\r\n<br><br>\r\n\r\nС уважением, администрация сайта {site}.\r\n", 1),
            array(5, 'passwordSuccessRecovery',         5, 'Шаблон письма с новым паролем после восстановления пароля.', NULL, '{from_mail}', '{to_mail}', 'Ваш новый пароль на сайте {site}.', "<h1>Восстановление пароля для сайта \"{site}\".</h1>\r\n<br>\r\n\r\nВаш новый пароль : <b>{password}</b><br>\r\nПомните – его всегда можно сменить в вашем профиле на сайте.\r\n<br>\r\nИспользуя данный пароль, вы можете теперь воти используя <a href=\"{login_url}\">страницу входа</a>\r\n<br>\r\n{login_url}\r\n<br><br>\r\n\r\nС уважением, администрация сайта {site}.\r\n", 1),
            array(6, 'userAccountActivationMailEvent',  6, 'Шаблон письма с подтверждением успешной активации аккаунта.', NULL, '{from_mail}', '{to_mail}', 'Подтверждение активации аккаунта на сайте {site}.', "<h1>Ваш аккаунт на сайте \"{site}\" успешно активирован!</h1>\r\n\r\n    <br/><br/>\r\n\r\nТеперь вы можете войти используя <a href=\"{login_url}\">страницу входа</a>\r\n<br>\r\n{login_url}\r\n<br><br>\r\n\r\nС уважением, администрация сайта {site}.\r\n", 1),
            array(7, 'userAccountEmailChangeMailEvent',   7, 'Шаблон письма с просьбой подтверждения ящика после смены e-mail адреса.', NULL, '{from_mail}', '{to_mail}', 'Подтверждение регистрации на сайте {site}. Требуется активация нового e-mail адреса.', "Здравствуйте!\r\n<br><br>\r\nВы запросили изменение e-mail адреса на сайте \"{site}\" на этот адрес. \r\n    <br/><br/>\r\nДля активации нового адреса, пожалуйста, перейдите по <a href=\"{url}\">ссылке</a>\r\n<br/><br/>\r\n{url}\r\n<br/><br/>\r\nС уважением, администрация сайта {site}.\r\n", 1),
        ) ;
    ...
    {
        $this->delete('{{mail_mail_event}}',array('id'=>array(1,2,3,4,5,6,7)));
        $this->delete('{{mail_mail_template}}',array('id'=>array(1,2,3,4,5,6,7)));
    }
}