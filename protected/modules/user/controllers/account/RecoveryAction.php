            ...
            {         
                ...
                if ($module->autoRecoveryPassword)
                {
                    ...
                    if ($recovery->save())
                    {
                        ...
                        Yii::app()->mail->send($module->notifyEmailFrom, $user->email, Yii::t('user', 'Восстановление пароля!'), $emailBody);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        Yii::log(Yii::t('user', 'При восстановлении пароля произошла ошибка!'), CLogger::LEVEL_ERROR, UserModule::$logCategory);
                        $this->controller->redirect(array('/user/account/recovery'));
                    }
                }
            }
