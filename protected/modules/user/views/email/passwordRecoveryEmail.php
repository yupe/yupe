<html>
<head>
    <title><?php echo Yii::t('user', 'Восстановление пароля');?> <?php echo CHtml::encode(Yii::app()->name);?>
        !</title>
</head>
<body>
<?php echo Yii::t('user', 'Восстановление пароля для сайта');?>
...
<?php echo Yii::t('user', 'Для восстановления пароля, пожалуйста, пройдите по');?>
<a
