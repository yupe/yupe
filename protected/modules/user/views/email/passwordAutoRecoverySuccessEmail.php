<html>
<head>
    <title><?php echo Yii::t('user', 'Восстановление пароля на сайте');?> <?php echo CHtml::encode(Yii::app()->name);?>
        !</title>
</head>
<body>
<?php echo Yii::t('user', 'Восстановление пароля на сайте');?> <b><?php echo CHtml::encode(Yii::app()->name);?>
    !</b><br/>
