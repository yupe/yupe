...
<body>
<?php echo Yii::t('user', 'Сброс пароля для сайта');?>
<b><?php echo CHtml::encode(Yii::app()->name);?></b> !<br/>
...
<?php echo Yii::t('user', 'Для сброса пароля,пожалуйста, перейдите по ');?> <a
...
/index.php/user/account/recoveryPassword/code/<?php echo $model->code;?>
