...
$this->menu=array(
	...
	array('icon' => 'pencil', 'label' => Yii::t('MailModule.mail', 'Edit event'), 'url' => array(
		'/mail/eventBackend/update',
		'id' => $model->id
	)),
	array('icon' => 'eye-open', 'label' => Yii::t('MailModule.mail', 'View mail event'), 'url' => array(
		'/mail/eventBackend/view',
		'id' => $model->id
	)),
	array('icon' => 'trash', 'label' => Yii::t('MailModule.mail', 'Remove event'), 'url' => '#', 'linkOptions' => array(
