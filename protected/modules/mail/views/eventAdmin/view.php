...
$this->menu=array(
    ...
    array('icon'=> 'file', 'label' =>  Yii::t('mail','Добавление события'),'url'=>array('/mail/eventAdmin/create')),
    ...
    array('icon'=> 'file', 'label' =>  Yii::t('mail','Добавить  шаблон'),'url'=>array('/mail/templateAdmin/create/','eid' => $model->id)),
