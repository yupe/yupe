...
<div class="alert alert-info"><?php echo Yii::t('mail','Поля, отмеченные');?> <span class="required">*</span> <?php echo Yii::t('mail','обязательны');?></div>

	<?php echo  $form->errorSummary($model); ?>
        
<div class='control-group <?php echo $model->hasErrors("event_id")?"error":"" ?>'><?php echo  $form->dropDownListRow($model,'event_id',CHtml::listData(MailEvent::model()->findAll(),'id','name'),array('class'=>'span7','maxlength'=>10,'empty' => Yii::t('mail','--выберите--'))); ?></div>
	...
	<div class='control-group <?php echo $model->hasErrors("from")?"error":"" ?>'><?php echo  $form->textFieldRow($model,'from',array('class'=>'span7','maxlength'=>300)); ?></div>

	<div class='control-group <?php echo $model->hasErrors("to")?"error":"" ?>'><?php echo  $form->textFieldRow($model,'to',array('class'=>'span7','maxlength'=>300)); ?></div>

	<div class='control-group <?php echo $model->hasErrors("theme")?"error":"" ?>'><?php echo  $form->textFieldRow($model,'theme',array('rows'=>6, 'cols'=>50, 'class'=>'span7')); ?></div>
