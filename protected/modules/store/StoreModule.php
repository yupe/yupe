            ...
            [
                ...
                'items'       => [
                    [
                        ...
                        'items'       => [
                            ['type' => AuthItem::TYPE_OPERATION, 'name' => 'Store.AttributeBackend.Index', 'description' => Yii::t("StoreModule.attr", 'View attribute list'),],
                            ['type' => AuthItem::TYPE_OPERATION, 'name' => 'Store.AttributeBackend.Create', 'description' => Yii::t("StoreModule.attr", 'Create attribute'),],
                    ...
                    [
                        ...
                        'items'       => [
                            ['type' => AuthItem::TYPE_OPERATION, 'name' => 'Store.CategoryBackend.Index', 'description' => Yii::t("StoreModule.category", 'List of categories'),],
                            ['type' => AuthItem::TYPE_OPERATION, 'name' => 'Store.CategoryBackend.Create', 'description' => Yii::t("StoreModule.category", 'Create category'),],
                    ...
                    [
                        ...
                        'items'       => [
                            ['type' => AuthItem::TYPE_OPERATION, 'name' => 'Store.ProducerBackend.Index', 'description' => Yii::t("StoreModule.producer", 'View producer list'),],
                            ['type' => AuthItem::TYPE_OPERATION, 'name' => 'Store.ProducerBackend.Create', 'description' => Yii::t("StoreModule.producer", 'Create producer'),],
                    ...
                    [
                        ...
                        'items'       => [
                            ['type' => AuthItem::TYPE_OPERATION, 'name' => 'Store.ProductBackend.Index', 'description' => Yii::t("StoreModule.product", 'View product list'),],
                            ['type' => AuthItem::TYPE_OPERATION, 'name' => 'Store.ProductBackend.Create', 'description' => Yii::t("StoreModule.product", 'Create product'),],
                    ...
                    [
                        ...
                        'items'       => [
                            ['type' => AuthItem::TYPE_OPERATION, 'name' => 'Store.TypeBackend.Index', 'description' => Yii::t("StoreModule.type", 'Types list'),],
                            ['type' => AuthItem::TYPE_OPERATION, 'name' => 'Store.TypeBackend.Create', 'description' => Yii::t("StoreModule.type", 'Types list'),],
