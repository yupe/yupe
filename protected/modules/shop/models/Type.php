...
class Type extends \yupe\models\YModel
{
    ...
    public function relations()
    {
        return array(
            ...
            'typeAttributes' => array(self::HAS_MANY, 'Attribute', array('attribute_id' => 'id'), 'through' => 'attributeRelation'),
        );
    }
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'name' => Yii::t('ShopModule.product', 'Название'),
            'main_category_id' => Yii::t('ShopModule.product', 'Главная категория'),
            'categories' => Yii::t('ShopModule.product', 'Дополнительные категории'),
        );
    }
