 ...
 *
 * The followings are the available columns in table 'shop_delivery':
 * @property integer $id
...
class Delivery extends yupe\models\YModel
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('price, free_from, available_from', 'shop\components\validators\NumberValidator'),
    ...
    {
        return array(
            'id' => Yii::t('ShopModule.delivery', 'ID'),
            'name' => Yii::t('ShopModule.delivery', 'Название'),
            'description' => Yii::t('ShopModule.delivery', 'Описание'),
            'status' => Yii::t('ShopModule.delivery', 'Статус'),
            'position' => Yii::t('ShopModule.delivery', 'Позиция'),
            'price' => Yii::t('ShopModule.delivery', 'Стоимость'),
            'free_from' => Yii::t('ShopModule.delivery', 'Бесплатна от'),
            'available_from' => Yii::t('ShopModule.delivery', 'Доступна от'),
            'separate_payment' => Yii::t('ShopModule.delivery', 'Оплачивается отдельно'),
            'payment_methods' => Yii::t('ShopModule.delivery', 'Способы оплаты'),
        );
    }
