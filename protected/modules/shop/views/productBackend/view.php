<?php
    ...
    $this->pageTitle = Yii::t('ShopModule.product', 'Products - view');
    ...
    $this->menu = array(
        ...
        array('icon' => 'trash', 'label' => Yii::t('ShopModule.product', 'Delete product'), 'url' => '#', 'linkOptions' => array(
...
<div class="page-header">
    <h1>
        <?php echo Yii::t('ShopModule.product', 'Product show'); ?><br />
