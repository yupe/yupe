...
(9, 0, 1, 'Войти', '/user/account/login', 'isAuthenticated', 1, 9, 1),
(10, 0, 1, 'Выйти', '/user/account/logout', 'isAuthenticated', 0, 10, 1),
(11, 0, 1, 'Регистрация', '/user/account/registration', 'isAuthenticated', 1, 11, 1),
