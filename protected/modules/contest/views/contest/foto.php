...
<?php $this->widget('application.modules.vote.widgets.VoteWidget', array(
                                                                        'model' => 'Image',
                                                                        'modelId' => $model->id
                                                                   ));?>
...
<?php $this->widget('application.modules.comment.widgets.CommentFormWidget', array('redirectTo' => $this->createUrl('/contest/contest/foto/', array('id' => $model->id)), 'model' => $model, 'modelId' => $model->id)); ?>
