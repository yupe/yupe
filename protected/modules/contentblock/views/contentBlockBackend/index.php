    ...
    array(
        ...
        'columns' => array(
            ...
            array(
                ...
                'type' => 'raw',
                'value' => '$data->getType()',
                'filter' => CHtml::activeDropDownList($model, 'type', $model->getTypes(), array('class' => 'form-control', 'empty' => '')),
            ),
            array(
                'class' => 'bootstrap.widgets.TbEditableColumn',
                'name' => 'code',
                ...
                'filter' => CHtml::activeTelField($model, 'code', array('class' => 'form-control')),
            ),
            array(
                'class' => 'bootstrap.widgets.TbEditableColumn',
                'name' => 'description',
                ...
                'filter' => CHtml::activeTelField($model, 'description', array('class' => 'form-control')),
            ),
            array(
