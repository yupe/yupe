...
return array(
    ...
    'ContentBlockGroupWidget Desc' => 'Описание параметров:<br><ul><li>category - код категории. Обязательный парамерт;</li><li>limit - какое количество блоков выводить. Не обязательный парамерт;</li><li>cacheTime - время жизни кэша (как часто обновляется кэш). Не обязательный парамерт;</li></ul>'
);
