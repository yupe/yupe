...
<p>Вы используете Yii версии <b><?php echo Yii::getVersion();?></b>, <?php echo CHtml::encode(Yii::app()->name);?> версии <b><?php echo Yii::app()->yupe->getVersion();?></b>, php <?php echo Yii::t('yupe','версии');?> <b><?php echo phpversion();?></b></p>

<p><?php echo Yii::t('yupe','Установлено модулей:');?> <b><?php echo count($modules) + count($yiiModules);?></b> </p>

<?php if(count($modules)):?>
   <p><?php echo Yii::t('yupe','Модули разработанные специально для ');?> <?php echo CHtml::encode(Yii::app()->name);?> (<?php echo count($modules); ?>):</p>
   <table class="items">
    <thead>
      <tr>
