...
- #1917: SEO: Добавлен компонент chemezov/yii-seo. Лэйауты и вьюх подогнаны под него. В модели добавлено поведение, которое позволяет вызывать функции getUrl/getAbsoluteUrl, возвращающие url к текущей модели. Добавлен EDbUrlManager, для модуля page изменён роут, страницы теперь доступны из корня сайта (http://example.com/my-page) (@chemezov) 
