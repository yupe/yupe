...
- #806: Добавлена примитивная поддержка NestedSets в комментариях. (DexterHD)
- #1111: Исправлена ошибка при создании заданий (модуль queue) из за неверно сформированных индексов (angel-kulikov)
- #1119: Автоматическая смена пункта меню и удаление при редактировании и удалении страницы (DexterHD)
- #1135: Исправлена ошибка формирования Alias. Теперь точки в alias транслируются в "_" (DexterHD)
- #1136: Добавлена библиотека подсветки кода Highlight.js (DexterHD)
...
- #1150: Исправлена ошибка при создании страниц (DexterHD)
- #1152: Исправлена ошибка при создании страниц при использовании PostgreSQL (DexterHD)
...
- #1158: Исправлен баг при котором из-за валидатора Url не грузились редакторы при работе с записями блогов (DexterHD)
...
- #1162: Исправлена ошибка: Не появляются ошибки на шаге инсталятора createUser (DexterHD)
...
- #1208: Исправлены прямые ссылки на ресурсы тем (yupe, DexterHD)
...
- #1059: Исправлена проблема с языками и параметрами модуля (DexterHD)
- #1060: Изменена стандартная длинна капчи (от 3 до 6 символов) (DexterHD)
...
- #1074: Исправлено поведение автогенерации поля URL. URL генерируется автоматом только если до этого не был указан пользователем (DexterHD)
- #1075: Для блогов, постов, новостей и комментариев добавлен экспорт в RSS (yupe)
- #1077: Исправлен баг с Русскоязычными ссылками в Новоcтях. Добавлен отдельный валидатор для проверки URL с поддержкой русских символов и UTF-8 (DexterHD)
- #1080: Обновлён YiiBooster до версии 1.0.7 (angel-kulikov)
- #1083: Исправлена ошибка с экранированием "Описания" блогов (DexterHD)
...
- #1030: Исправлена ошибка аутерификации при которой не сохранялась сессия после закрытия браузера (DexterHD)
- #1036: Добавлена возможность автологина с настройкой количества дней в течениии которых будет храниться сессия (DexterHD)
...
- #1048 Правка стиля отступа для формы комментариев (DexterHD)
...
- #994: Исправлено поведение всех форм панели управления (DexterHD)
...
- #658: Исправлена ошибка при сохранении страниц с одинаковыми заголовками (DexterHD)
- #659: Из выбора в установщике убраны лишние базы (DexterHD)
- #660: Исправлены слипшиеся теги в теме default (DexterHD)
