...
- #1611: Заполненность поля комментария теперь проверяется и на JS (@yupe)
...
- #1631: Панель редатора зафиксирована (@DarkCs)
- #1632: Переработан механиз подключения редакторов https://github.com/yupe/yupe/issues/1632 (@DarkCs)
- #1652: Добавлена ссылка «Модули» в верхнем меню. Иконки модулей и меню заменены на font-awesome вместо glyphicon (@chemezov)
